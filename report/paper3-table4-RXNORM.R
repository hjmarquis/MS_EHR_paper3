...
write.csv(out.table,"MS CLIME analysis/result/table4RN-RXNORM.csv", row.names = F)
...
write.csv(out.table,"MS CLIME analysis/result/table4DF-RXNORM.csv", row.names = F)
